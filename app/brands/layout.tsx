...
export const metadata: Metadata = {
  title: "WBSQ Brands — Twenty-three businesses, six sectors",
  description:
  ...
  openGraph: {
    title: "WBSQ Brands — Twenty-three businesses, six sectors",
    description:
      "Twenty-three WBSQ businesses, each with its own customers and craft.",
    type: "website",
    images: [],
  },
  twitter: {
    card: "summary",
    title: "WBSQ Brands — Twenty-three businesses, six sectors",
    description: "Twenty-three WBSQ businesses, each with its own customers and craft.",
    images: [],
  },
};
