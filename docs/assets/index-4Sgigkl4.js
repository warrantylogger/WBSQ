...
void main(){
  ...
  vec4 c0 = vec4((${Sl.toFixed(6)} / ar) * (r0.x + uOffsetX * ar * w0 / uDist), ${Sl.toFixed(6)} * r0.y, 0.0, w0);
  vec4 c1 = vec4((${Sl.toFixed(6)} / ar) * (r1.x + uOffsetX * ar * w1 / uDist), ${Sl.toFixed(6)} * r1.y, 0.0, w1);
...
void main(){
  ...
  vec4 clip = vec4((${Sl.toFixed(6)} / ar) * (r.x + uOffsetX * ar * w / uDist), ${Sl.toFixed(6)} * r.y, 0.0, w);
  ...
  gl_PointSize = max(1.0, radius * (1.0 + v_probe * 0.9) * ${Sl.toFixed(6)} * uRes.y / w);
